...
namespace ISSLab.Model.Entities
{
    public class Constants
    {
        ...
        public const string EXTENDED_AUCTION_POST_TYPE = "AuctionMarketplacePost";
        public const string DONATION_POST_TYPE = "Donation";
        public const string EXTENDED_DONATION_POST_TYPE = "DonationMarketplacePost";
        public const string FIXED_PRICE_POST_TYPE = "FixedPrice";
        public const string EXTENDED_FIXED_PRICE_POST_TYPE = "FixedPriceMarketplacePost";
        public const string DEFAULT_POST_TYPE = "marketplacePost";
