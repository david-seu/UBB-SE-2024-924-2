namespace ISSLab.Model.Entities
{
    public class GroupNonMarketplace
    {
        ...
        public GroupNonMarketplace(Guid id, Guid ownerId, string name, string description, string icon, string banner, int maxPostsPerHourPerUser, bool isPublic, bool canMakePostsByDefault, string groupCode)
        {
            Id = id;
            OwnerId = ownerId;
            Name = name;
